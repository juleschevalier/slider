...
public class TestIndividualRules {
    ...
    public void testCAX_SCO() {
        ...
        // RunCAX_SCO runCAX_SCO = new RunCAX_SCO(dictionary, tripleStore, new
        // AtomicInteger());
        //
        // /*
        // * Test with matching triples
        // */
        // long c1 = dictionary.add("c1"), c2 = dictionary.add("c2"), x =
        // dictionary.add("x");
        //
        // Triple t1 = new ImmutableTriple(c1, AbstractDictionary.subClassOf,
        // c2), t2 = new ImmutableTriple(x, AbstractDictionary.type, c1);
        //
        // tripleStore.add(t1);
        // tripleStore.add(t2);
        //
        ...
        // Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        // TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        // RunPRP_DOM runPRP_DOM = new RunPRP_DOM(dictionary, tripleStore, new
        // AtomicInteger());
        //
        // /*
        // * Test with matching triples
        // */
        // long x = dictionary.add("x"), y = dictionary.add("y"), p =
        // dictionary.add("p"), c = dictionary.add("c");
        //
        // Triple t1 = new ImmutableTriple(p, AbstractDictionary.domain, c), t2
        // = new ImmutableTriple(x, p, y);
        //
        // tripleStore.add(t1);
        // tripleStore.add(t2);
        //
        ...
        // Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        // TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        // RunPRP_RNG runPRP_RNG = new RunPRP_RNG(dictionary, tripleStore, new
        // AtomicInteger());
        //
        // /*
        // * Test with matching triples
        ...
        // dictionary.add("p"), c = dictionary.add("c");
        //
        // Triple t1 = new ImmutableTriple(p, AbstractDictionary.range, c), t2 =
        // new ImmutableTriple(x, p, y);
        //
        // tripleStore.add(t1);
        // tripleStore.add(t2);
        ...
        // Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        // TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        // RunSCM_SCO runSCM_SCO = new RunSCM_SCO(dictionary, tripleStore, new
        // AtomicInteger());
        //
        // /*
        // * Test with matching triples
        // */
        // long c1 = dictionary.add("c1"), c2 = dictionary.add("c2"), c3 =
        // dictionary.add("c3");
        //
        // Triple t1 = new ImmutableTriple(c1, AbstractDictionary.subClassOf,
        // c2), t2 = new ImmutableTriple(c2, AbstractDictionary.subClassOf, c3);
        //
        // tripleStore.add(t1);
        // tripleStore.add(t2);
        //
        ...
        // Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        // TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        // RunPRP_SPO1 runPRP_SPO1 = new RunPRP_SPO1(dictionary, tripleStore,
        // new AtomicInteger());
        //
        // }
        //
        ...
        // Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        // TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        // RunSCM_DOM1 runSCM_DOM1 = new RunSCM_DOM1(dictionary, tripleStore,
        // new AtomicInteger());
        //
        // }
        //
        ...
        // Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        // TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        // RunSCM_DOM2 runSCM_DOM2 = new RunSCM_DOM2(dictionary, tripleStore,
        // new AtomicInteger());
        //
        // }
        //
        ...
        // Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        // TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        // RunSCM_EQC2 runSCM_EQC2 = new RunSCM_EQC2(dictionary, tripleStore,
        // new AtomicInteger());
        //
        // }
        //
        ...
        // Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        // TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        // RunSCM_EQP2 runSCM_EQP2 = new RunSCM_EQP2(dictionary, tripleStore,
        // new AtomicInteger());
        //
        // }
        //
        ...
        // Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        // TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        // RunSCM_RNG1 runSCM_RNG1 = new RunSCM_RNG1(dictionary, tripleStore,
        // new AtomicInteger());
        //
        // }
        //
        ...
        // Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        // TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        // RunSCM_RNG2 runSCM_RNG2 = new RunSCM_RNG2(dictionary, tripleStore,
        // new AtomicInteger());
        //
        // }
        //
        ...
        // Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        // TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        // RunSCM_SPO runSCM_SPO = new RunSCM_SPO(dictionary, tripleStore, new
        // AtomicInteger());
        //
        // }
    }
