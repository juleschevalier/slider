...
public class TestIndividualRuns {
    ...
    public void testCAX_SCO() {
        ...
        final RunCAX_SCO runCAX_SCO = new RunCAX_SCO(dictionary, tripleStore, new QueuedTripleBufferLock(1000), new TripleDistributor(), new AtomicInteger());
    ...
    public void testPRP_DOM() {
        final Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        final TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        final RunPRP_DOM runPRP_DOM = new RunPRP_DOM(dictionary, tripleStore, new QueuedTripleBufferLock(1000), new TripleDistributor(), new AtomicInteger());
    ...
    public void testPRP_RNG() {
        final Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        final TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        final RunPRP_RNG runPRP_RNG = new RunPRP_RNG(dictionary, tripleStore, new QueuedTripleBufferLock(1000), new TripleDistributor(), new AtomicInteger());
    ...
    public void testSCM_SCO() {
        final Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        final TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        final RunSCM_SCO runSCM_SCO = new RunSCM_SCO(dictionary, tripleStore, new QueuedTripleBufferLock(1000), new TripleDistributor(), new AtomicInteger());
    ...
    public void testPRP_SPO1() {
        final Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        final TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        final RunPRP_SPO1 runPRP_SPO1 = new RunPRP_SPO1(dictionary, tripleStore, new QueuedTripleBufferLock(1000), new TripleDistributor(), new AtomicInteger());

        /*
         * Test with matching triples
         */
        final long p1 = dictionary.add("p1"), p2 = dictionary.add("p2"), x = dictionary.add("x"), y = dictionary.add("y");
    ...
    public void testSCM_DOM1() {
        final Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        final TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        final RunSCM_DOM1 runSCM_DOM1 = new RunSCM_DOM1(dictionary, tripleStore, new QueuedTripleBufferLock(1000), new TripleDistributor(), new AtomicInteger());
    ...
    public void testSCM_DOM2() {
        ...
        final Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        final TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        final RunSCM_DOM2 runSCM_DOM2 = new RunSCM_DOM2(dictionary, tripleStore, new QueuedTripleBufferLock(1000), new TripleDistributor(), new AtomicInteger());
    ...
    public void testSCM_EQC2() {
        ...
        final Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        final TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        final RunSCM_EQC2 runSCM_EQC2 = new RunSCM_EQC2(dictionary, tripleStore, new QueuedTripleBufferLock(1000), new TripleDistributor(), new AtomicInteger());
    ...
    public void testSCM_EQP2() {
        ...
        final Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        final TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        final RunSCM_EQP2 runSCM_EQC2 = new RunSCM_EQP2(dictionary, tripleStore, new QueuedTripleBufferLock(1000), new TripleDistributor(), new AtomicInteger());
    ...
    public void testSCM_RNG1() {
        ...
        final Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        final TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        final RunSCM_RNG1 runSCM_RNG1 = new RunSCM_RNG1(dictionary, tripleStore, new QueuedTripleBufferLock(1000), new TripleDistributor(), new AtomicInteger());
    ...
    public void testSCM_RNG2() {
        ...
        final Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        final TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        final RunSCM_RNG2 runSCM_RNG2 = new RunSCM_RNG2(dictionary, tripleStore, new QueuedTripleBufferLock(1000), new TripleDistributor(), new AtomicInteger());
    ...
    public void testSCM_SPO() {
        ...
        final Dictionary dictionary = new DictionaryPrimitrivesRWLock();
        final TripleStore tripleStore = new VerticalPartioningTripleStoreRWLock();
        final RunSCM_SPO runSCM_SPO = new RunSCM_SPO(dictionary, tripleStore, new QueuedTripleBufferLock(1000), new TripleDistributor(), new AtomicInteger());
