 ...
 * p rdfs:domain c2
 */
public class Mark1mtSCM_DOM1 extends AbstractRuleMT{

	private static Logger logger = Logger.getLogger(Mark1mtSCM_DOM1.class);

	public Mark1mtSCM_DOM1(Dictionnary dictionnary, TripleStore usableTriples,  Collection<Triple> newTriples, TripleStore tripleStore) {
		super();
		this.dictionnary = dictionnary;
		this.tripleStore = tripleStore;
		this.usableTriples = usableTriples;
		this.newTriples = newTriples;
		this.ruleName = "SCM_DOM1";
	}
