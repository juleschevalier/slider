...
public class Mark1PRP_RNG extends AbstractRule {
	...
	public Mark1PRP_RNG(Dictionnary dictionnary, TripleStore usableTriples,
			Collection<Triple> newTriples, TripleStore tripleStore, CountDownLatch doneSignal) {
		super(dictionnary,tripleStore,usableTriples,newTriples,"PRP_RNG",doneSignal);
	...
	public void run() {
		...
		/* Use usableTriples */
			...
			for (Triple t1 : usableTriples.getAll()) {
				...
				for (Triple t2 : (p1 == range)?tripleStore.getAll():range_Triples) {
