 ...
 * x rdf:type c2
 */
public class Mark1mtCAX_SCO extends AbstractRuleMT{

	private static Logger logger = Logger.getLogger(Mark1mtCAX_SCO.class);

	public Mark1mtCAX_SCO(Dictionnary dictionnary, TripleStore usableTriples,  Collection<Triple> newTriples, TripleStore tripleStore) {
		super();
