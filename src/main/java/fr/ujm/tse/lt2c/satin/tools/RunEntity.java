...
public class RunEntity {
    ...
    public RunEntity(String file, int sessionId, long loops, int nbDuplicates, long inferenceTime, long nbInitialTriples, long nbInferedTriples, List<String> missingTriples, List<String> tooTriples) {
        super();
        ...
        this.nbMissingTriples = missingTriples.size() + "";
        this.nbTooTriples = tooTriples.size() + "";
