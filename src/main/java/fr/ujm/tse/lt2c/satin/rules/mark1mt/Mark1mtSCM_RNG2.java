 ...
 * p1 rdfs:range c
 */
public class Mark1mtSCM_RNG2 extends AbstractRuleMT {

	private static Logger logger = Logger.getLogger(Mark1mtSCM_RNG2.class);

	public Mark1mtSCM_RNG2(Dictionnary dictionnary, TripleStore usableTriples,  Collection<Triple> newTriples, TripleStore tripleStore) {
		super();
