 ...
 * x rdf:type c
 */
public class Mark1mtPRP_DOM extends AbstractRuleMT {

	private static Logger logger = Logger.getLogger(Mark1mtPRP_DOM.class);

	public Mark1mtPRP_DOM(Dictionnary dictionnary, TripleStore usableTriples,  Collection<Triple> newTriples, TripleStore tripleStore) {
		super();
