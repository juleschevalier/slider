 ...
 */
public class Mark1mtSCM_SPO extends AbstractRuleMT {

	private static Logger logger = Logger.getLogger(Mark1mtSCM_SPO.class);

	public Mark1mtSCM_SPO(Dictionnary dictionnary, TripleStore usableTriples,  Collection<Triple> newTriples, TripleStore tripleStore) {
		super();
