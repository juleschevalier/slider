 ...
 * p1 rdfs:domain c
 */
public class Mark1mtSCM_DOM2 extends AbstractRuleMT {

	private static Logger logger = Logger.getLogger(Mark1mtSCM_DOM2.class);

	public Mark1mtSCM_DOM2(Dictionnary dictionnary, TripleStore usableTriples,  Collection<Triple> newTriples, TripleStore tripleStore) {
		super();
