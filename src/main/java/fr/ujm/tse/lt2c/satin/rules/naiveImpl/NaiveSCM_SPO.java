...
public class NaiveSCM_SPO implements Rule {
	private static Logger logger = Logger.getLogger(NaiveSCM_SPO.class);
	private Dictionnary dictionnary;
	private TripleStore tripleStore;

	public NaiveSCM_SPO(Dictionnary dictionnary, TripleStore tripleStore) {
		super();
