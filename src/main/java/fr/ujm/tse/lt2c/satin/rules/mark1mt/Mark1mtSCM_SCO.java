 ...
 */
public class Mark1mtSCM_SCO extends AbstractRuleMT {

	private static Logger logger = Logger.getLogger(Mark1mtSCM_SCO.class);

	public Mark1mtSCM_SCO(Dictionnary dictionnary, TripleStore usableTriples,  Collection<Triple> newTriples, TripleStore tripleStore) {
		super();
