 ...
 */
public class Mark1mtSCM_EQC2 extends AbstractRuleMT {

	private static Logger logger = Logger.getLogger(Mark1mtSCM_EQC2.class);

	public Mark1mtSCM_EQC2(Dictionnary dictionnary, TripleStore usableTriples,  Collection<Triple> newTriples, TripleStore tripleStore) {
		super();
		this.dictionnary = dictionnary;
		this.tripleStore = tripleStore;
		this.usableTriples = usableTriples;
		this.newTriples = newTriples;
		this.ruleName = "SCM_EQC2";
	}
