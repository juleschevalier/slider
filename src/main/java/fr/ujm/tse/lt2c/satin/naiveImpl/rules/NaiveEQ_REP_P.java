...
public class NaiveEQ_REP_P implements Rule {

	private static Logger logger = Logger.getLogger(NaiveEQ_REP_P.class);
	private Dictionnary dictionnary;
	private TripleStore tripleStore;

	public NaiveEQ_REP_P(Dictionnary dictionnary, TripleStore tripleStore) {
		super();
