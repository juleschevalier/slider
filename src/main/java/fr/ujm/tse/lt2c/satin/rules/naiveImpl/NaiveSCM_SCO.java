...
public class NaiveSCM_SCO implements Rule {
	
	private static Logger logger = Logger.getLogger(NaiveSCM_SCO.class);
	private Dictionnary dictionnary;
	private TripleStore tripleStore;

	public NaiveSCM_SCO(Dictionnary dictionnary, TripleStore tripleStore) {
		super();
