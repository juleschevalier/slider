...
public class NaivePRP_EQP1 implements Rule {

	private static Logger logger = Logger.getLogger(NaivePRP_EQP1.class);
	private Dictionnary dictionnary;
	private TripleStore tripleStore;

	public NaivePRP_EQP1(Dictionnary dictionnary, TripleStore tripleStore) {
		super();
