...
public class NaiveSCM_EQP1 implements Rule {

	private static Logger logger = Logger.getLogger(NaiveSCM_EQP1.class);
	private Dictionnary dictionnary;
	private TripleStore tripleStore;

	public NaiveSCM_EQP1(Dictionnary dictionnary, TripleStore tripleStore) {
		super();
